...
cosCarrier = cos(2*pi/lambda*rot_x+psi);% \\TODO: Implement the cosine given rot_x, lambda and psi.
...
sinCarrier = sin(2*pi/lambda*rot_x+psi); % \\TODO: Implement the sine given rot_x, lambda and psi.
...
gaussEnv = exp(-.5*(rot_x.^2/sigma^2+rot_y.^2/(sigma/gamma)^2)); % \\TODO: Implement the Gaussian envelope.
